...
!     INSERTED
      prop_avg(1,2:nj-1) = (2*prop(2,2:nj-1)-prop(3,2:nj-1)+prop(1,1:nj-2)+prop(1,3:nj))/3.0
      prop_avg(ni,2:nj-1) = (2*prop(ni-1,2:nj-1)-prop(ni-2,2:nj-1)+prop(ni,1:nj-2)+prop(ni,3:nj))/3.0
